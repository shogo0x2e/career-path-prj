            ...
            <div className="flex flex-col space-y-6">
                ...
                >
                    <div className="space-y-6">
                        ...
                        {/* キャリアプランニングセクション */}
                        <div>
                            <h2 className="text-xl font-semibold mb-4">キャリアプランニング</h2>

                            <div className="space-y-4">
                                {/* できること */}
                                <div className="space-y-2">
                                    <label htmlFor="canDo" className="block font-medium text-gray-700">
                                        できること
                                    </label>
                                    <textarea
                                        id="canDo"
                                ...
                                {/* やりたいこと */}
                                <div className="space-y-2">
                                    <label htmlFor="wantToDo" className="block font-medium text-gray-700">
                                        やりたいこと
                                    </label>
                                    <textarea
                                        id="wantToDo"
                                ...
                                {/* やりたくないこと */}
                                <div className="space-y-2">
                                    <label htmlFor="dontWantToDo" className="block font-medium text-gray-700">
                                        やりたくないこと
                                    </label>
                                    <textarea
                                        id="dontWantToDo"
